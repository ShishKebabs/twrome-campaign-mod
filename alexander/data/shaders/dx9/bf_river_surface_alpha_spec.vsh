...
dp3 r4.x, r6.xyzz,	r6.xyzz ; magnitude squared
rsq r4.xyz, r4.xxxx ; get the inverse of the square
mul r6.xyz, r6.xyzz, r4.xyzz ; multiply, r6 = - (camera vector)
...
mul r2.y, r2.y, r2.y
mul r2.y, r2.y, r2.y
mad r1.xyzw, r2.xxxx, r2.yyyy, c1.yyyy	; diffuse_alpha = max_alpha + cos(pitch) * alpha

;
; Calc specular lighting
;
add r2.xyz, r6.xyzz, -c10.xyzz	; get half angle... camera vector + direction to light

dp3 r4.x, r2.xyzz,	r2.xyzz ; magnitude squared
rsq r4.xyz, r4.xxxx ; get the inverse of the square
mul r2.xyz, r2.xyzz, r4.xyzz ; multiply, r2 = half vector

mov r4.x, -c10.y ; assume the normal is directly up
mov r4.y, r2.y ; normal 'dot' half vector (normal is up)
